  ...
  return (
    <div>
      ...
      <section className="relative h-[85vh] min-h-[500px] overflow-hidden">
        <img src={heroBanner} <img src={heroBanner} alt="Moda masculina Nobile" className="absolute inset-0 w-full h-full object-cover" /> className="absolute inset-0 w-full h-full object-cover" />
